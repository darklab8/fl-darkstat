...
var file_darkstat_proto_rawDesc = string([]byte{
	...
	0x72, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x0a, 0x0a, 0x08, 0x54, 0x68, 0x72, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x22, 0x3c, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x63, 0x74,
	...
	0x65, 0x72, 0x32, 0xe8, 0x07, 0x0a, 0x08, 0x44, 0x61, 0x72, 0x6b, 0x73, 0x74, 0x61, 0x74, 0x12,
	...
	0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x49,
	...
	,
...
var file_darkstat_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_darkstat_proto_goTypes = []any{
	...
	nil,                             // 63: statproto.Tractor.BasesEntry
	nil,                             // 64: statproto.GetHashesReply.HashesByNickEntry
}
var file_darkstat_proto_depIdxs = []int32{
	...
	42, // 30: statproto.GetTractorsReply.Items:type_name -> statproto.Tractor
	63, // 31: statproto.Tractor.Bases:type_name -> statproto.Tractor.BasesEntry
	64, // 32: statproto.GetHashesReply.HashesByNick:type_name -> statproto.GetHashesReply.HashesByNickEntry
	47, // 33: statproto.GetPoBsReply.Items:type_name -> statproto.PoB
	10, // 34: statproto.PoBCore.BasePos:type_name -> statproto.Pos
	46, // 35: statproto.PoB.Core:type_name -> statproto.PoBCore
	48, // 36: statproto.PoB.ShopItems:type_name -> statproto.ShopItem
	50, // 37: statproto.GetPoBGoodsReply.Items:type_name -> statproto.PoBGood
	51, // 38: statproto.PoBGood.Bases:type_name -> statproto.PoBGoodBase
	48, // 39: statproto.PoBGoodBase.ShopItem:type_name -> statproto.ShopItem
	46, // 40: statproto.PoBGoodBase.Base:type_name -> statproto.PoBCore
	53, // 41: statproto.GetGraphPathsInput.Queries:type_name -> statproto.GraphPathQuery
	55, // 42: statproto.GetGraphPathsReply.Answers:type_name -> statproto.GetGraphPathsAnswer
	53, // 43: statproto.GetGraphPathsAnswer.Route:type_name -> statproto.GraphPathQuery
	56, // 44: statproto.GetGraphPathsAnswer.Time:type_name -> statproto.GraphPathTime
	8,  // 45: statproto.Base.MarketGoodsPerNickEntry.value:type_name -> statproto.MarketGood
	8,  // 46: statproto.Commodity.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 47: statproto.Ammo.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 48: statproto.CounterMeasure.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 49: statproto.Engine.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 50: statproto.Tractor.BasesEntry.value:type_name -> statproto.MarketGood
	44, // 51: statproto.GetHashesReply.HashesByNickEntry.value:type_name -> statproto.Hash
	0,  // 52: statproto.Darkstat.GetHealth:input_type -> statproto.Empty
	3,  // 53: statproto.Darkstat.GetBasesNpc:input_type -> statproto.GetBasesInput
	3,  // 54: statproto.Darkstat.GetBasesMiningOperations:input_type -> statproto.GetBasesInput
	3,  // 55: statproto.Darkstat.GetBasesPoBs:input_type -> statproto.GetBasesInput
	0,  // 56: statproto.Darkstat.GetPoBs:input_type -> statproto.Empty
	0,  // 57: statproto.Darkstat.GetPoBGoods:input_type -> statproto.Empty
	11, // 58: statproto.Darkstat.GetCommodities:input_type -> statproto.GetCommoditiesInput
	2,  // 59: statproto.Darkstat.GetAmmos:input_type -> statproto.GetEquipmentInput
	2,  // 60: statproto.Darkstat.GetCounterMeasures:input_type -> statproto.GetEquipmentInput
	2,  // 61: statproto.Darkstat.GetEngines:input_type -> statproto.GetEquipmentInput
	24, // 62: statproto.Darkstat.GetFactions:input_type -> statproto.GetFactionsInput
	4,  // 63: statproto.Darkstat.GetTractors:input_type -> statproto.GetTractorsInput
	0,  // 64: statproto.Darkstat.GetHashes:input_type -> statproto.Empty
	52, // 65: statproto.Darkstat.GetGraphPaths:input_type -> statproto.GetGraphPathsInput
	1,  // 66: statproto.Darkstat.GetHealth:output_type -> statproto.HealthReply
	5,  // 67: statproto.Darkstat.GetBasesNpc:output_type -> statproto.GetBasesReply
	5,  // 68: statproto.Darkstat.GetBasesMiningOperations:output_type -> statproto.GetBasesReply
	5,  // 69: statproto.Darkstat.GetBasesPoBs:output_type -> statproto.GetBasesReply
	45, // 70: statproto.Darkstat.GetPoBs:output_type -> statproto.GetPoBsReply
	49, // 71: statproto.Darkstat.GetPoBGoods:output_type -> statproto.GetPoBGoodsReply
	12, // 72: statproto.Darkstat.GetCommodities:output_type -> statproto.GetCommoditiesReply
	14, // 73: statproto.Darkstat.GetAmmos:output_type -> statproto.GetAmmoReply
	20, // 74: statproto.Darkstat.GetCounterMeasures:output_type -> statproto.GetCounterMeasuresReply
	22, // 75: statproto.Darkstat.GetEngines:output_type -> statproto.GetEnginesReply
	25, // 76: statproto.Darkstat.GetFactions:output_type -> statproto.GetFactionsReply
	41, // 77: statproto.Darkstat.GetTractors:output_type -> statproto.GetTractorsReply
	43, // 78: statproto.Darkstat.GetHashes:output_type -> statproto.GetHashesReply
	54, // 79: statproto.Darkstat.GetGraphPaths:output_type -> statproto.GetGraphPathsReply
