...
var file_darkstat_proto_rawDesc = string([]byte{
	...
	0x22, 0x06, 0x0a, 0x04, 0x53, 0x68, 0x69, 0x70, 0x22, 0x3e, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x54,
	...
	0x46, 0x72, 0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x72, 0x32, 0xb6, 0x08, 0x0a, 0x08, 0x44, 0x61,
	...
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x4c, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x54, 0x68, 0x72, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x73, 0x12, 0x1c, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x70, 0x72, 0x6f, 0x74,
	...
	,
...
var file_darkstat_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_darkstat_proto_goTypes = []any{
	...
	(*GetThrustersReply)(nil),       // 39: statproto.GetThrustersReply
	(*Thruster)(nil),                // 40: statproto.Thruster
	(*GetTractorsReply)(nil),        // 41: statproto.GetTractorsReply
	(*Tractor)(nil),                 // 42: statproto.Tractor
	(*GetHashesReply)(nil),          // 43: statproto.GetHashesReply
	(*Hash)(nil),                    // 44: statproto.Hash
	(*GetPoBsReply)(nil),            // 45: statproto.GetPoBsReply
	(*PoBCore)(nil),                 // 46: statproto.PoBCore
	(*PoB)(nil),                     // 47: statproto.PoB
	(*ShopItem)(nil),                // 48: statproto.ShopItem
	(*GetPoBGoodsReply)(nil),        // 49: statproto.GetPoBGoodsReply
	(*PoBGood)(nil),                 // 50: statproto.PoBGood
	(*PoBGoodBase)(nil),             // 51: statproto.PoBGoodBase
	(*GetGraphPathsInput)(nil),      // 52: statproto.GetGraphPathsInput
	(*GraphPathQuery)(nil),          // 53: statproto.GraphPathQuery
	(*GetGraphPathsReply)(nil),      // 54: statproto.GetGraphPathsReply
	(*GetGraphPathsAnswer)(nil),     // 55: statproto.GetGraphPathsAnswer
	(*GraphPathTime)(nil),           // 56: statproto.GraphPathTime
	nil,                             // 57: statproto.Base.MarketGoodsPerNickEntry
	nil,                             // 58: statproto.Commodity.BasesEntry
	nil,                             // 59: statproto.Ammo.BasesEntry
	nil,                             // 60: statproto.DiscoveryTechCompat.TechcompatByIDEntry
	nil,                             // 61: statproto.CounterMeasure.BasesEntry
	nil,                             // 62: statproto.Engine.BasesEntry
	nil,                             // 63: statproto.Thruster.BasesEntry
	nil,                             // 64: statproto.Tractor.BasesEntry
	nil,                             // 65: statproto.GetHashesReply.HashesByNickEntry
}
var file_darkstat_proto_depIdxs = []int32{
	...
	57, // 2: statproto.Base.MarketGoodsPerNick:type_name -> statproto.Base.MarketGoodsPerNickEntry
	...
	58, // 7: statproto.Commodity.Bases:type_name -> statproto.Commodity.BasesEntry
	15, // 8: statproto.GetAmmoReply.Items:type_name -> statproto.Ammo
	59, // 9: statproto.Ammo.Bases:type_name -> statproto.Ammo.BasesEntry
	16, // 10: statproto.Ammo.DiscoveryTechCompat:type_name -> statproto.DiscoveryTechCompat
	60, // 11: statproto.DiscoveryTechCompat.TechcompatByID:type_name -> statproto.DiscoveryTechCompat.TechcompatByIDEntry
	...
	61, // 15: statproto.CounterMeasure.Bases:type_name -> statproto.CounterMeasure.BasesEntry
	...
	62, // 18: statproto.Engine.Bases:type_name -> statproto.Engine.BasesEntry
	...
	40, // 29: statproto.GetThrustersReply.Items:type_name -> statproto.Thruster
	63, // 30: statproto.Thruster.Bases:type_name -> statproto.Thruster.BasesEntry
	16, // 31: statproto.Thruster.DiscoveryTechCompat:type_name -> statproto.DiscoveryTechCompat
	42, // 32: statproto.GetTractorsReply.Items:type_name -> statproto.Tractor
	64, // 33: statproto.Tractor.Bases:type_name -> statproto.Tractor.BasesEntry
	65, // 34: statproto.GetHashesReply.HashesByNick:type_name -> statproto.GetHashesReply.HashesByNickEntry
	47, // 35: statproto.GetPoBsReply.Items:type_name -> statproto.PoB
	10, // 36: statproto.PoBCore.BasePos:type_name -> statproto.Pos
	46, // 37: statproto.PoB.Core:type_name -> statproto.PoBCore
	48, // 38: statproto.PoB.ShopItems:type_name -> statproto.ShopItem
	50, // 39: statproto.GetPoBGoodsReply.Items:type_name -> statproto.PoBGood
	51, // 40: statproto.PoBGood.Bases:type_name -> statproto.PoBGoodBase
	48, // 41: statproto.PoBGoodBase.ShopItem:type_name -> statproto.ShopItem
	46, // 42: statproto.PoBGoodBase.Base:type_name -> statproto.PoBCore
	53, // 43: statproto.GetGraphPathsInput.Queries:type_name -> statproto.GraphPathQuery
	55, // 44: statproto.GetGraphPathsReply.Answers:type_name -> statproto.GetGraphPathsAnswer
	53, // 45: statproto.GetGraphPathsAnswer.Route:type_name -> statproto.GraphPathQuery
	56, // 46: statproto.GetGraphPathsAnswer.Time:type_name -> statproto.GraphPathTime
	8,  // 47: statproto.Base.MarketGoodsPerNickEntry.value:type_name -> statproto.MarketGood
	8,  // 48: statproto.Commodity.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 49: statproto.Ammo.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 50: statproto.CounterMeasure.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 51: statproto.Engine.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 52: statproto.Thruster.BasesEntry.value:type_name -> statproto.MarketGood
	8,  // 53: statproto.Tractor.BasesEntry.value:type_name -> statproto.MarketGood
	44, // 54: statproto.GetHashesReply.HashesByNickEntry.value:type_name -> statproto.Hash
	0,  // 55: statproto.Darkstat.GetHealth:input_type -> statproto.Empty
	3,  // 56: statproto.Darkstat.GetBasesNpc:input_type -> statproto.GetBasesInput
	3,  // 57: statproto.Darkstat.GetBasesMiningOperations:input_type -> statproto.GetBasesInput
	3,  // 58: statproto.Darkstat.GetBasesPoBs:input_type -> statproto.GetBasesInput
	0,  // 59: statproto.Darkstat.GetPoBs:input_type -> statproto.Empty
	0,  // 60: statproto.Darkstat.GetPoBGoods:input_type -> statproto.Empty
	11, // 61: statproto.Darkstat.GetCommodities:input_type -> statproto.GetCommoditiesInput
	2,  // 62: statproto.Darkstat.GetAmmos:input_type -> statproto.GetEquipmentInput
	2,  // 63: statproto.Darkstat.GetCounterMeasures:input_type -> statproto.GetEquipmentInput
	2,  // 64: statproto.Darkstat.GetEngines:input_type -> statproto.GetEquipmentInput
	2,  // 65: statproto.Darkstat.GetThrusters:input_type -> statproto.GetEquipmentInput
	24, // 66: statproto.Darkstat.GetFactions:input_type -> statproto.GetFactionsInput
	4,  // 67: statproto.Darkstat.GetTractors:input_type -> statproto.GetTractorsInput
	0,  // 68: statproto.Darkstat.GetHashes:input_type -> statproto.Empty
	52, // 69: statproto.Darkstat.GetGraphPaths:input_type -> statproto.GetGraphPathsInput
	1,  // 70: statproto.Darkstat.GetHealth:output_type -> statproto.HealthReply
	5,  // 71: statproto.Darkstat.GetBasesNpc:output_type -> statproto.GetBasesReply
	5,  // 72: statproto.Darkstat.GetBasesMiningOperations:output_type -> statproto.GetBasesReply
	5,  // 73: statproto.Darkstat.GetBasesPoBs:output_type -> statproto.GetBasesReply
	45, // 74: statproto.Darkstat.GetPoBs:output_type -> statproto.GetPoBsReply
	49, // 75: statproto.Darkstat.GetPoBGoods:output_type -> statproto.GetPoBGoodsReply
	12, // 76: statproto.Darkstat.GetCommodities:output_type -> statproto.GetCommoditiesReply
	14, // 77: statproto.Darkstat.GetAmmos:output_type -> statproto.GetAmmoReply
	20, // 78: statproto.Darkstat.GetCounterMeasures:output_type -> statproto.GetCounterMeasuresReply
	22, // 79: statproto.Darkstat.GetEngines:output_type -> statproto.GetEnginesReply
	39, // 80: statproto.Darkstat.GetThrusters:output_type -> statproto.GetThrustersReply
	25, // 81: statproto.Darkstat.GetFactions:output_type -> statproto.GetFactionsReply
	41, // 82: statproto.Darkstat.GetTractors:output_type -> statproto.GetTractorsReply
	43, // 83: statproto.Darkstat.GetHashes:output_type -> statproto.GetHashesReply
	54, // 84: statproto.Darkstat.GetGraphPaths:output_type -> statproto.GetGraphPathsReply
